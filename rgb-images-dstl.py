...
N_Cls = 10
DF = pd.read_csv('datasets/train_wkt_v4.csv')
GS = pd.read_csv('datasets/grid_sizes.csv', names=['ImageId', 'Xmax', 'Ymin'], skiprows=1)
ISZ = 160
smooth = 1e-12
...
def M(image_id):
    ...
    img = tiff.imread('datasets/three_band/{}.tif'.format(image_id))
