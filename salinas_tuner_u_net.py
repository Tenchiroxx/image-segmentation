...
if __name__ == "__main__":
    ...
    class CNNHyperModel(HyperModel):
        ...
        def build(self, hp):
            ...
            nb_filters = hp.Choice("nb_filters_0", values=[8, 16, 32])
    ...
    tuner = BayesianOptimization(hypermodel, objective='val_accuracy', max_trials=500, num_initial_points=2, seed=2, directory = "SALINAS_unet_random_search", max_model_size=100000000, overwrite=True)
