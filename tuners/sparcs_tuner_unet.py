...
"""This tuner is used to determine the best hyperparameters for the U-Net on the SPARCS/Landsat-8 dataset"""
...
if __name__ == "__main__":
    ...
    tuner = BayesianOptimization(hypermodel, objective='accuracy', max_trials=500, num_initial_points=2, seed=2, directory = "SPARCS_unet_random_search", max_model_size=100000000, overwrite=True)
